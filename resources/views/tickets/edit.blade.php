                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3 col-sm-9">
                                    <input type="text" id="txt_solicitud_caso" name="txt_solicitud_caso" class="form-control" placeholder="Asunto del caso"  minlength="5" maxlength="50" value="{{ $ticket->nombre_caso }}" >
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3 col-sm-9">
                                    <textarea class="form-control" name="textDescripcion" id="textDescripcion" cols="30" rows="4" placeholder="Descripción del caso..."  minlength="1" maxlength="255" >{{ $ticket->descripcion }}</textarea>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
