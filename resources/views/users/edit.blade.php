@extends('layouts.base')
    @section('title-content')
        <h1 class="m-0"><i class="fas fa-plus"></i>Editar Usuario</h1>
    @endsection
    @section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3 col-sm-9">
                                    <input type="text" id="txt_num_doc" name="txt_num_doc" class="form-control" placeholder="Número Doc" minlength="4" maxlength="15" value="{{ $person->num_doc }}" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3 col-sm-9">
                                    <input type="text" id="txt_nombre_comp" name="txt_nombre_comp" class="form-control" placeholder="¿Cual es su nombre?"  minlength="5" maxlength="255" value="{{ $person->nombre_completo }}" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3 col-sm-9">
                                    <input type="text" id="txt_email" name="txt_email" class="form-control" placeholder="email"  minlength="5" maxlength="255" value="{{ $person->email }}" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3 col-sm-9">
                                    <input type="text" id="txt_telefono" name="txt_telefono" class="form-control" placeholder="Télefono"  minlength="10" maxlength="10" value="{{ $person->telefono }}" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
